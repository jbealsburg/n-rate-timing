...
Are there plots that received nitrogen in the fall prior to their first harvest? I assume yes.
...
```{r, include=T,warning=F,fig.cap= "Yields at all 3 sites range from 0-150 kg ha. We expect yields ranging from 0-1000 kg ha. Why are yields so low?"}
theme_set(theme_bw())
